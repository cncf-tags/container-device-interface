...
func (v defaultValidator) ValidateAny(o interface{}) (rerr error) {
	defer func() {
		if rerr != nil {
...
func (v defaultValidator) Validate(s *cdi.Spec) (rerr error) {
	...
	for _, d := range s.Devices {
		...
		seen[d.Name] = true
		if err := v.ValidateDevice(s.Kind, &d); err != nil {
...
func (v defaultValidator) ValidateDevice(kind string, d *cdi.Device) error {
